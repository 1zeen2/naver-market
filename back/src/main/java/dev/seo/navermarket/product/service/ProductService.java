package dev.seo.navermarket.product.service;
...
public interface ProductService {
     ...
     * @throws IllegalArgumentEaxception 유효하지 않은 상품 상태가 제공될 경우
     */
     ...
     */
	ProductDetailResponseDto createProduct(
     ...
     * @param requestDto 수정할 상품 정보와 새로운 이미지 URL 목록이 담긴 DTO (ProductUpdateRequestDto)
